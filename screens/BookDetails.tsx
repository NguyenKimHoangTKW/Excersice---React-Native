...
const BookDetail = ({ route, navigation }) => {
    ...
    async function getBookDetail(bookId) {
        const response = await fetch(`${BASE_URL}/detail_books`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
            body: JSON.stringify({ id_books: bookId })
        });
    ...
    function renderBookInfoSection() {
        ...
        return (
            ...
            <View style={{ flex: 1 }}>
                <ImageBackground
                    source={bookCoverMap[book.bookCover]}
                    resizeMode="cover"
                    style={{
                        position: 'absolute',
                        top: 0,
                ...
                >
                    ...
                    {/* Language */}
                    <View style={{ flex: 1, alignItems: 'center' }}>
                        <Text style={{ ...FONTS.h3, color: COLORS.white }}>{book.acronym}</Text>
